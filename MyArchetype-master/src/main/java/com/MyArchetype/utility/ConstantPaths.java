...
public class ConstantPaths {
	...
	public static final String testResourcePath = projectFilePath + "src" + File.separator + "test" + File.separator
			+ "resources" + File.separator;

	public static final String locatorFilePath = testResourcePath + "locators" + File.separator;

	public static final String locatorsPropertiesFilePath = locatorFilePath + File.separator + "locators.properties";

	public static final String testDataFilePath = testResourcePath + "testdata" + File.separator;

	public static final String credentialsFilePath = testDataFilePath + File.separator + "credentials.properties";
	...
	public static final String dateExcelPath =  "C:\\Users\\sakthi.sekar\\Desktop\\Date.xlsx";
	
	public static final String log4jFilePath = testResourcePath + "log4j" + File.separator;

	public static final String log4jPropertiesFilePath = log4jFilePath + "log4j.properties";
